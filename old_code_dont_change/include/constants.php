...
define('LOG_RSP', 5);
define('LOG_RSP_RANG', 6);
define('RSP_LOG_HANDEL', 1);
define('RSP_LOG_UNTERNEHMEN', 2);
define('RSP_LOG_PRODUKTION', 3);
define('RSP_LOG_HAENDLER', 4);
...
// RSP-Tabellen
//define('RSP_USER_DATA_TABLE',			$table_prefix . 'rsp_user_data');
define('RSP_USER_RESS_TABLE',			$table_prefix . 'rsp_user_ress');
define('RSP_UNTERNEHMEN_TABLE',			$table_prefix . 'rsp_unternehmen');
define('RSP_UNTERNEHMEN_BETRIEBE_TABLE',$table_prefix . 'rsp_unternehmen_betriebe');
define('RSP_BETRIEBE_TABLE',			$table_prefix . 'rsp_betriebe');
define('RSP_BETRIEBE_ROHSTOFFE_TABLE',	$table_prefix . 'rsp_betriebe_rohstoffe');
define('RSP_GEBAUDE_INFO_TABLE', 	    $table_prefix . 'rsp_gebaude_info');
define('RSP_BETRIEBE_KOSTEN_TABLE', 	$table_prefix . 'rsp_betriebe_kosten');
define('RSP_GUETERBEREICH_TABLE',		$table_prefix . 'rsp_gueterbereich');
define('RSP_RESSOURCEN_TABLE',			$table_prefix . 'rsp_ressourcen');
define('RSP_RESSOURCEN_BEREICH_TABLE',	$table_prefix . 'rsp_ressourcen_bereich');
define('RSP_CHANGELOG_TABLE',			$table_prefix . 'rsp_changelog');
define('RSP_PROVINZEN_TABLE',			$table_prefix . 'rsp_provinzen');
define('RSP_PROVINZ_ROHSTOFF_TABLE',	$table_prefix . 'rsp_provinz_rohstoff');
define('RSP_LAND_TABLE',				$table_prefix . 'rsp_land');
define('RSP_HANDEL_LOG_TABLE',			$table_prefix . 'rsp_handel_log');
define('RSP_HAENDLER_TABLE',			$table_prefix . 'rsp_haendler');
define('RSP_PRODUKTIONS_LOG_TABLE',		$table_prefix . 'rsp_produktions_log');
define('RSP_RAENGE_TABLE',				$table_prefix . 'rsp_raenge');
define('RSP_LOG_TABLE',			    	$table_prefix . 'rsp_log');
define('RSP_BAU_LOG_TABLE',			    $table_prefix . 'rsp_bau_log');
define('RSP_STORY_TABLE',			    $table_prefix . 'rsp_story');
define('RSP_STORY_ACTIONS_TABLE',		$table_prefix . 'rsp_story_actions');
define('RSP_STORY_OPTIONS_TABLE',		$table_prefix . 'rsp_story_options');
define('RSP_STORY_PART_TABLE',			$table_prefix . 'rsp_story_part');
define('RSP_STORY_USER_TABLE',			$table_prefix . 'rsp_story_user');
//MILSIM
define('RSP_EINHEITEN_ART_TABLE',			$table_prefix . 'rsp_einheiten_art');

// Feste Variablen
define('MAX_UNTERNEHMEN_ZIVIL', 3);
define('MAX_UNTERNEHMEN_AMTTRAEGER', 1);
define('MAX_BETRIEBE', 5);
define('MAX_PRODUKTIONSSCHLEIFE', 5);
define('HAENDLER_ID', 130);
define('HAENDLER_SPANNE', 25);
define('NEUTRALE_GEBAUDE_ID', 6);
define('LAGER_ID', 45);
define('MAX_CREDITS', 1000000000);
define('MAX_RESS', 25000);
define('LAGERPLATZ', 25000);

//alte???
define('RSP_USER_GEBAUDE_TABLE',		$table_prefix . 'rsp_user_gebaude');
